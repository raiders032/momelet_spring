...
public class RestaurantRepositoryImpl implements RestaurantRepositoryCustom{
    ...
    @Override
    public Page<RestaurantResponseDto> searchRestaurantsOrderByLikeCount(Pageable pageable, RestaurantSearchCondition condition) {
    ...
    @Override
    public Page<RestaurantResponseDto> searchRestaurantsOrderByDistance(Pageable pageable, RestaurantSearchCondition condition) {
